...
<script>
    var vm = new Vue({
        ...
        methods: {
            ...
            //         if (valid) {
            //             self.list.push({ id: counts, name: self.ruleForm2.name, image: self.ruleForm2.image, price: self.ruleForm2.price, number: self.ruleForm2.age, checked: false, num: 1, remove: false });
            //
